		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aufträge Komponentenzusammenstellung",
									"targetURL": "#comiffprodstatimixer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comiffprodstatimixer-display": {
								"semanticObject": "comiffprodstatimixer",
								"action": "display",
								"description": "Anzeige von Mischer und Auftragsdaten",
								"title": "Aufträge Komponentenzusammenstellung",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.iff.prodstatimixer",
									"url": sap.ui.require.toUrl("com/iff/prodstatimixer")
								}
							}
						}
					}
